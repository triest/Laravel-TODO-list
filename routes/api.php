...
Route::apiResource('todo-list', \App\Http\Controllers\Ajax\TodoListController::class);
...
Route::post('todo-list/{todo_list}/tag',[\App\Http\Controllers\Ajax\TodoListController::class,'addTag']);
